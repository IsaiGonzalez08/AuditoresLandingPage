    ...
    return(
        <div className='flex flex-col border-2 border-[#397A80] w-[378px] h-[424px] rounded-[20px] hover:scale-105 hover:duration-300'>
            ...
            <div className='flex flex-col m-3 gap-3'>
                ...
                <div>
                    <button className='hover:scale-105 hover:duration-300 mt-5 flex rounded-[20px] w-[112px] h-[31px] justify-center items-center text-[#397A80] border-2 border-[#397A80] font-bold text-xs bg-[#FCFEFE]'>
                        Contactar
