    ...
    return(
        <div className="flex items-center justify-around bg-[#FCFEFE] w-full h-32">
            ...
            <div className="flex gap-14 items-center">
                ...
                <NavLink className='text-[#548BA5] text-base font-medium hover:scale-105 hover:duration-300 hover:border-b-2 hover:border-[#397A80] hover:font-bold' to="/Servicios">Servicios</NavLink>
